					...
					<div class="infos">
						<table class="field">
							<tr>
								...
								<td><input type="text" cssClass="text" key="title" name="title" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" cssClass="text" key="floorage"
										name="floorage" /></td>
							</tr>
							<tr>
								<td class="field">价 格：</td>
								<td><input type="text" cssClass="text" key="price" name="price" />
								</td>
							</tr>

							<tr>
								<td class="field">房产证日期：</td>
								<td><input type="text" cssClass="text" key="houseDate"
										name="houseDate" /></td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" cssClass="text" key="contact"
										name="contact" /></td>
							</tr>
							<tr>
